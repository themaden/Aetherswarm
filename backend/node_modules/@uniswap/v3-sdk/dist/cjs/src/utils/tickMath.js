...
class TickMath {
    ...
    static getSqrtRatioAtTick(tick) {
        ...
        if (tick > 0)
            ratio = jsbi_1.default.divide(sdk_core_1.MaxUint256, ratio);
        // back to Q96
        return jsbi_1.default.greaterThan(jsbi_1.default.remainder(ratio, Q32), internalConstants_1.ZERO)
            ? jsbi_1.default.add(jsbi_1.default.divide(ratio, Q32), internalConstants_1.ONE)
