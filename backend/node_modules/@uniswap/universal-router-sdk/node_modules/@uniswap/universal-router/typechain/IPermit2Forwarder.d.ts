...
interface IPermit2ForwarderInterface extends ethers.utils.Interface {
  functions: {
...
export class IPermit2Forwarder extends Contract {
  ...
  interface: IPermit2ForwarderInterface;
