...
interface BaseActionsRouterInterface extends ethers.utils.Interface {
  functions: {
...
export class BaseActionsRouter extends Contract {
  ...
  interface: BaseActionsRouterInterface;
