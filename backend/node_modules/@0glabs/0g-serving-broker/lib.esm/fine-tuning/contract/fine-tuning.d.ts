...
import type { DeliverableStructOutput } from './typechain/FineTuningServing';
import { ReadOnlyFineTuningServingContract } from './read-only-fine-tuning';
export declare class FineTuningServingContract extends ReadOnlyFineTuningServingContract {
    signer: Wallet;
