...
class LedgerBroker {
     ...
     */
    getProvidersWithBalance = async (serviceTypeStr) => {
        try {
     ...
     * @throws Will throw an error if the fund retrieval operation fails.
     */
    retrieveFundFromProvider = async (serviceTypeStr, providerAddress, gasPrice) => {
        try {
            return await this.ledger.retrieveFundFromProvider(serviceTypeStr, providerAddress, gasPrice);
        }
        catch (error) {
            (0, utils_1.throwFormattedError)(error);
        }
