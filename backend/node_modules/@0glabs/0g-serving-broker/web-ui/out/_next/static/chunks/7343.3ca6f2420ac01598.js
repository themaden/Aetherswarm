"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[7343],{37343:(C,l,H)=>{H.r(l),H.d(l,{reownSvg:()=>h});var F=H(48362);let h=(0,F.JW)`<svg width="60" height="16" viewBox="0 0 60 16" fill="none"">
